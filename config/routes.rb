Rails.application.routes.draw do
  ...
  get '/my-orders', to: "home_pages#my_orders", as: "my_orders"
  post '/create-order', to: "home_pages#create_order", as: "create_order"
  get '/checkout', to: "home_pages#checkout", as: "checkout"
  get 'order-summary', to: "home_pages#order_summary", as: "order_summary"
  ...
  put '/products/update', to: "home_pages#update_cart_item", as: "update_cart_item"
  delete '/products/:product_id', to: "home_pages#delete_cart_item", as: "delete_cart_item"
  ...
  get '/wishlist', to: "home_pages#my_wishlist", as: "my_wishlist"
  get '/cart', to: "home_pages#my_cart", as: "my_cart"
  post '/products/add', to: "home_pages#add_product_to_cart", as: "add_product_to_cart"
  post '/products/wishlist', to: "home_pages#add_product_to_wishlist", as: "add_product_to_wishlist"
